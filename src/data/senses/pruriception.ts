...
const pruriception: Sense = {
  id: 'pruriception',
  title: 'Pruriception – The Itch Sense',
  ...
  content: `
    <div class="border-l-2 border-amber-700 pl-4 py-2">
      ...
      <p class="text-amber-200">Content for Pruriception will be added here.</p>
    </div>
  `
};

export default pruriception;
